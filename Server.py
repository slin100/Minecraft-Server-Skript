...
# build the server
	...
	if input("Do you agree to the eula at https://account.mojang.com/documents/minecraft_eula \n [Y/N]").lower() == "y":
		...
		file_url = ["https://launcher.mojang.com/v1/objects/1b557e7b033b583cd9f66746b7a9ab1ec1673ced/server.jar", "https://launcher.mojang.com/v1/objects/0a269b5f2c5b93b1712d0f5dc43b6182b9ab254e/server.jar"]
		whatV = int(input("What server version? 1.16.5[0] 1.17[1]\n"))
